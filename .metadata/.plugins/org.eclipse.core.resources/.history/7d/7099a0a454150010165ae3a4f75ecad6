...
/* Registers for various periperhals */
...
//__disable();
    ...
    /* **********************************
     * Leave the following regs alone
     * **********************************
     * p_src->STM.STM[0].SR[0].B.ECC
     * p_src->STM.STM[0].SR[0].B.SRR
     * p_src->STM.STM[0].SR[0].B.CLRR
     * p_src->STM.STM[0].SR[0].B.SETR
     * p_src->STM.STM[0].SR[0].B.IOV
     * p_src->STM.STM[0].SR[0].B.IOVCLR
     * p_src->STM.STM[0].SR[0].B.SWS
     * p_src->STM.STM[0].SR[0].B.SWSCLR
     * ********************************** */
    ...
    p_stm0->ICR.B.CMP1EN    = 0;    /* Disable CMP1             */
